...
BOOST_AUTO_TEST_CASE(TestValues) {
  ...
  CheckIntInfo(SQL_GETDATA_EXTENSIONS, SQL_GD_ANY_COLUMN 
              | SQL_GD_ANY_ORDER | SQL_GD_BOUND | SQL_GD_BLOCK);
  CheckIntInfo(SQL_ODBC_INTERFACE_CONFORMANCE, SQL_OIC_CORE);
  CheckIntInfo(SQL_SQL_CONFORMANCE, SQL_SC_SQL92_ENTRY);
  CheckIntInfo(SQL_TIMEDATE_ADD_INTERVALS, SQL_FN_TSI_FRAC_SECOND | SQL_FN_TSI_SECOND | SQL_FN_TSI_MINUTE
      | SQL_FN_TSI_HOUR | SQL_FN_TSI_DAY | SQL_FN_TSI_WEEK | SQL_FN_TSI_MONTH
      | SQL_FN_TSI_QUARTER | SQL_FN_TSI_YEAR);
  CheckIntInfo(SQL_TIMEDATE_DIFF_INTERVALS, SQL_FN_TSI_FRAC_SECOND | SQL_FN_TSI_SECOND | SQL_FN_TSI_MINUTE
      | SQL_FN_TSI_HOUR | SQL_FN_TSI_DAY | SQL_FN_TSI_WEEK | SQL_FN_TSI_MONTH
      | SQL_FN_TSI_QUARTER | SQL_FN_TSI_YEAR);
  ...
  CheckIntInfo(SQL_OJ_CAPABILITIES, SQL_OJ_LEFT 
              | SQL_OJ_NOT_ORDERED | SQL_OJ_RIGHT 
              | SQL_OJ_ALL_COMPARISON_OPS);
  CheckIntInfo(SQL_POS_OPERATIONS, SQL_POS_POSITION | SQL_POS_REFRESH);
  CheckIntInfo(SQL_SQL92_DATETIME_FUNCTIONS, SQL_SDF_CURRENT_DATE | SQL_SDF_CURRENT_TIME
  ...
  CheckIntInfo(SQL_STATIC_CURSOR_ATTRIBUTES1, SQL_CA1_NEXT 
              ...
              | SQL_CA1_POS_REFRESH);
  CheckIntInfo(SQL_STATIC_CURSOR_ATTRIBUTES2, SQL_CA2_READ_ONLY_CONCURRENCY 
              | SQL_CA2_CRC_EXACT);
  ...
  if (DATABASE_AS_SCHEMA) {
    CheckIntInfo(SQL_SCHEMA_USAGE, SQL_SU_DML_STATEMENTS
  ...
  CheckIntInfo(SQL_NUMERIC_FUNCTIONS, SQL_FN_NUM_ABS | SQL_FN_NUM_ATAN
              | SQL_FN_NUM_ATAN2
  ...
  CheckIntInfo(SQL_STRING_FUNCTIONS, SQL_FN_STR_ASCII | SQL_FN_STR_LENGTH
              | SQL_FN_STR_LTRIM | SQL_FN_STR_REPLACE | SQL_FN_STR_RTRIM
              | SQL_FN_STR_SUBSTRING);

  CheckIntInfo(SQL_TIMEDATE_FUNCTIONS, SQL_FN_TD_CURDATE | SQL_FN_TD_DAYOFMONTH
              | SQL_FN_TD_MONTH | SQL_FN_TD_MONTHNAME | SQL_FN_TD_NOW | SQL_FN_TD_YEAR);

  CheckIntInfo(SQL_SQL92_NUMERIC_VALUE_FUNCTIONS, 0);

  CheckIntInfo(SQL_SQL92_STRING_FUNCTIONS, SQL_SSF_CONVERT | SQL_SSF_LOWER | SQL_SSF_UPPER
  ...
  CheckIntInfo(SQL_SQL92_RELATIONAL_JOIN_OPERATORS, SQL_SRJO_CROSS_JOIN | SQL_SRJO_INNER_JOIN
              | SQL_SRJO_LEFT_OUTER_JOIN | SQL_SRJO_RIGHT_OUTER_JOIN);

  CheckIntInfo(SQL_CONVERT_BIGINT, SQL_CVT_DOUBLE);
  CheckIntInfo(SQL_CONVERT_BINARY, 0);
  CheckIntInfo(SQL_CONVERT_BIT, 0);
  CheckIntInfo(SQL_CONVERT_CHAR, 0);
  CheckIntInfo(SQL_CONVERT_VARCHAR, 0);
