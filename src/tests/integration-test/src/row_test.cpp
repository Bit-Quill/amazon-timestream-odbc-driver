...
void FillMemWithData(timestream::impl::interop::InteropUnpooledMemory& mem,
                     size_t rowNum) {
  ...
  for (size_t i = 0; i < rowNum; ++i) {
    ...
    timestream::Guid guid(0x2b218f63642a4a64UL, 0x9674098f388ac298UL + i);
...
BOOST_AUTO_TEST_CASE(TestRowMoveToNext, *disabled()) {
  timestream::impl::interop::InteropUnpooledMemory mem(4096);
